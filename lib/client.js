	...
	factory: (require) => {
		...
		function lane(value, path) {
			...
			return {
				...
				...planReviewer === void 0 ? {} : { planReviewer: route$1(planReviewer, `${path}.planReviewer`) },
				...replanner === void 0 ? {} : { replanner: route$1(replanner, `${path}.replanner`) },
				...finalVerifier === void 0 ? {} : { finalVerifier: route$1(finalVerifier, `${path}.finalVerifier`) },
		...
		function decodeDispatcherConfigSnapshot(value) {
			...
			if (source["protocolVersion"] !== 2) fail$1("$.protocolVersion", "2");
		...
		function validateDispatcherDraft(config) {
			...
			for (const [id, lane] of laneEntries) {
				...
				if (lane.planReviewer !== void 0) route(errors, `${root}.planReviewer`, lane.planReviewer);
				if (lane.replanner !== void 0) route(errors, `${root}.replanner`, lane.replanner);
				if (lane.finalVerifier !== void 0) route(errors, `${root}.finalVerifier`, lane.finalVerifier);
				if (lane.planner === void 0) {
					for (const role of [
						"planReviewer",
						"replanner",
						"finalVerifier"
					]) if (lane[role] !== void 0) errors[`${root}.${role}`] = "planning-required";
				}
		...
		*/
		...
		var TaskDispatcherSettingsTab_module_css_default = {
			...
			"grid3": "OewtXG_grid3",
			"hint": "OewtXG_hint",
			"inheritedRoute": "OewtXG_inheritedRoute",
			"input": "OewtXG_input",
			"label": "OewtXG_label",
			...
			"modelScope": "OewtXG_modelScope",
			"modelsHead": "OewtXG_modelsHead",
			"notice": "OewtXG_notice",
			"page": "OewtXG_page",
			"pageHead": "OewtXG_pageHead",
			"roleCard": "OewtXG_roleCard",
			"roleGrid": "OewtXG_roleGrid",
			"roleHead": "OewtXG_roleHead",
			"roleState": "OewtXG_roleState",
			"route": "OewtXG_route",
		...
		function RoleRouteCard(props) {
			...
			const inherited = props.override !== void 0 && !props.override.checked;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				className: TaskDispatcherSettingsTab_module_css_default.roleCard,
				role: "group",
				"aria-labelledby": headingId,
				"data-inactive": props.inactive ? "true" : void 0,
				"data-inherited": inherited ? "true" : void 0,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TaskDispatcherSettingsTab_module_css_default.roleHead,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h5", {
							id: headingId,
							children: props.title
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: props.description })] }), props.inactive ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Pill, { children: props.t("settings.route.inactive") }) : inherited ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Pill, { children: props.t("settings.route.inherits", { role: props.override.inheritsFrom }) }) : null]
					}),
					props.override === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CheckField, {
						id: `${props.id}-override`,
						label: props.t("settings.route.override", { role: props.title }),
						hint: props.t(props.inactive ? "settings.route.overrideUnavailableHint" : props.override.locked ? "settings.route.overrideRequiredHint" : "settings.route.overrideHint", { role: props.override.inheritsFrom }),
					...
					props.inactive ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: TaskDispatcherSettingsTab_module_css_default.roleState,
						children: props.t("settings.route.inactiveHint")
					}) : inherited && props.route !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TaskDispatcherSettingsTab_module_css_default.inheritedRoute,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: props.t("settings.route.effectiveModel") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: routeLabel(props.route) })]
					}) : props.route === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RouteFields, {
						id: props.id,
						route: props.route,
						path: props.path,
						disabled: props.disabled,
		...
		function LaneEditor(props) {
			...
			const setOverride = (key, checked) => {
				props.edit((lane) => {
					if (!checked) {
						delete lane[key];
						return;
					}
					if (lane.planner === void 0) return;
					lane[key] = { ...key === "replanner" ? lane.planner : lane.verifier };
				});
			};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("summary", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: TaskDispatcherSettingsTab_module_css_default.modelsHead,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", { children: props.t("settings.lane.models") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: props.t("settings.lane.modelsIntro") })]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: TaskDispatcherSettingsTab_module_css_default.modelScope,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: props.t("settings.lane.parentModels", { lane: props.id }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: props.lane.orchestration.enabled && props.lane.orchestration.childLane !== "" ? props.t("settings.lane.childModels", { lane: props.lane.orchestration.childLane }) : props.t("settings.lane.childModelsHint") })]
						}),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: TaskDispatcherSettingsTab_module_css_default.roleGrid,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									id: `${uid}-planner`,
									...
									path: `${root}.planner`,
									disabled: props.disabled,
									inactive: props.lane.planner === void 0,
									t: props.t,
									error,
									onChange: (update) => {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									...
									inactive: props.lane.planner === void 0,
									override: {
										checked: props.lane.planReviewer !== void 0,
										locked: props.baseLane?.planReviewer !== void 0,
										inheritsFrom: props.t("settings.route.verifier"),
										onChange: (checked) => {
											setOverride("planReviewer", checked);
										}
									},
									t: props.t,
									error,
									onChange: (update) => {
										setRoute("planReviewer", update);
									}
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									id: `${uid}-replanner`,
									...
									inactive: props.lane.planner === void 0,
									override: {
										checked: props.lane.replanner !== void 0,
										locked: props.baseLane?.replanner !== void 0,
										inheritsFrom: props.t("settings.route.planner"),
										onChange: (checked) => {
											setOverride("replanner", checked);
										}
									},
									t: props.t,
									error,
									onChange: (update) => {
										setRoute("replanner", update);
									}
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									id: `${uid}-executor`,
									title: props.t("settings.route.executor"),
									description: props.t(props.lane.orchestration.enabled ? "settings.route.orchestrationExecutorDescription" : "settings.route.executorDescription"),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									...
									description: props.t(props.lane.orchestration.enabled ? "settings.route.orchestrationVerifierDescription" : "settings.route.verifierDescription"),
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleRouteCard, {
									...
									inactive: props.lane.planner === void 0,
									override: {
										checked: props.lane.finalVerifier !== void 0,
										locked: props.baseLane?.finalVerifier !== void 0,
										inheritsFrom: props.t("settings.route.verifier"),
										onChange: (checked) => {
											setOverride("finalVerifier", checked);
										}
									},
									t: props.t,
									error,
									onChange: (update) => {
										setRoute("finalVerifier", update);
									}
								})
							]
						}),
		...
		const zh = {
			...
			"settings.intro": "用清晰的表单管理任务通道、六种角色模型和分布式节点。保存不会打断正在运行的任务。",
			...
			"settings.lanes.intro": "每个通道独立分配规划、执行和验收角色的模型、工具与验收标准。内置通道可以调整但不能删除。",
			...
			"settings.lane.models": "按角色分配模型",
			"settings.lane.modelsIntro": "同一通道可为规划、执行和各级验收分配不同模型。没有单独设置的角色会使用下方注明的继承模型。",
			"settings.lane.parentModels": "这里配置父通道「{lane}」自己的角色模型。",
			"settings.lane.childModels": "DAG 子任务交给子通道「{lane}」，并使用该子通道自己的角色模型，不继承这里的设置。",
			"settings.lane.childModelsHint": "若启用子任务编排，DAG 子任务将使用所选 child lane 自己的角色模型。",
			...
			"settings.route.executor": "Executor 模型",
			"settings.route.verifier": "步骤验收模型",
			"settings.route.planner": "Master Planner 模型",
			"settings.route.planReviewer": "计划审核模型",
			"settings.route.replanner": "计划调整模型",
			"settings.route.finalVerifier": "最终验收模型",
			"settings.route.executorDescription": "专注执行当前通道直接分配的完整任务或线性计划步骤。",
			"settings.route.verifierDescription": "独立检查每次 Executor 的步骤结果和证据。",
			"settings.route.orchestrationExecutorDescription": "当前编排父通道不会直接运行此 Executor；DAG 节点使用所选 child lane 的 Executor。",
			"settings.route.orchestrationVerifierDescription": "当前编排父通道不会运行步骤验收；DAG 节点使用 child lane 的验收模型。计划审核和最终验收仍可继承此模型。",
			"settings.route.plannerDescription": "为当前父通道生成初始计划或宏观 DAG。",
			"settings.route.planReviewerDescription": "独立审核初始计划和后续计划补丁。",
			"settings.route.replannerDescription": "在 Host 的安全边界内调整尚未执行的计划。",
			"settings.route.finalVerifierDescription": "所有步骤或子任务汇合后，对原始目标做最终验收。",
			...
			"settings.route.override": "单独设置{role}",
			"settings.route.overrideHint": "关闭时继承{role}；开启后可设置独立的提供方、模型和 token 上限。",
			"settings.route.overrideRequiredHint": "这个单独角色设置来自内置通道，可以调整但不能改回继承。",
			"settings.route.overrideUnavailableHint": "启用 master plan 后才能单独设置这个角色。",
			"settings.route.inherits": "继承{role}",
			"settings.route.effectiveModel": "当前继承模型",
			"settings.route.inactive": "未启用",
			"settings.route.inactiveHint": "当前通道未启用 master plan，因此这个角色不会运行。",
			...
			"settings.validation.planning-required": "单独的规划角色模型要求先启用 master plan。"
		};
		const en = {
			...
			"settings.nav": "Task Dispatcher",
			"settings.title": "Task Dispatcher",
			"settings.intro": "Manage task lanes, six model roles, and distributed nodes with a clear form. Saving never interrupts running work.",
			...
			"settings.lanes.intro": "Each lane assigns its planning, execution, and verification role models, tools, and acceptance criteria independently. Built-in lanes may be adjusted but not deleted.",
			...
			"settings.lane.models": "Models by role",
			"settings.lane.modelsIntro": "Assign different models to planning, execution, and each review stage. Roles without an override inherit the model named below.",
			"settings.lane.parentModels": "These assignments belong to parent lane “{lane}”.",
			"settings.lane.childModels": "DAG children run on child lane “{lane}” and use that lane’s own role models; they do not inherit these assignments.",
			"settings.lane.childModelsHint": "If orchestration is enabled, DAG children use the selected child lane’s own role models.",
			...
			"settings.route.verifier": "Step verifier model",
			"settings.route.planner": "Master Planner model",
			"settings.route.planReviewer": "Plan reviewer model",
			"settings.route.replanner": "Replanner model",
			"settings.route.finalVerifier": "Final verifier model",
			"settings.route.executorDescription": "Executes a complete task or linear-plan step assigned directly to this lane.",
			"settings.route.verifierDescription": "Independently checks each Executor result and its evidence.",
			"settings.route.orchestrationExecutorDescription": "This orchestration parent does not run this Executor directly. DAG nodes use the selected child lane’s Executor.",
			"settings.route.orchestrationVerifierDescription": "This orchestration parent does not run step verification. DAG nodes use the child lane’s verifier; plan review and final verification may still inherit this model.",
			"settings.route.plannerDescription": "Creates the initial plan or macro DAG for this parent lane.",
			"settings.route.planReviewerDescription": "Independently reviews the initial plan and later plan patches.",
			"settings.route.replannerDescription": "Adjusts work that has not started at a Host-enforced safe boundary.",
			"settings.route.finalVerifierDescription": "Checks the original objective after every step or child task has joined.",
			...
			"settings.route.override": "Set {role} separately",
			"settings.route.overrideHint": "When off, inherit {role}. Turn it on to set a separate provider, model, and token limit.",
			"settings.route.overrideRequiredHint": "This separate role assignment comes from a built-in lane. It may be adjusted but not returned to inheritance.",
			"settings.route.overrideUnavailableHint": "Enable a master plan before assigning this role separately.",
			"settings.route.inherits": "Inherits {role}",
			"settings.route.effectiveModel": "Current inherited model",
			"settings.route.inactive": "Not enabled",
			"settings.route.inactiveHint": "This lane has no master plan, so this role does not run.",
			...
			"settings.validation.planning-required": "Role-specific planning models require an enabled master plan."
		};
		//#endregion
